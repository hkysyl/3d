...
def upload_img(dir_files):
    for img in dir_files:
        ...
        # file = open(os.path.join(f'static/pro/', f'{new_uuid4}_{img.name}'), 'wb')

        file = open(os.path.join(f'static/pro/', f'{img.name}'), 'wb')
        ...
        for chunk in img.chunks():
            ...
            pcd.pcd_url = rf'static/pro/' + img.name
